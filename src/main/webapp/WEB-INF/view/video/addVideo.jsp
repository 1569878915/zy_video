...
<body>
	...
	<%-- <form  action="${pageContext.request.contextPath}/video/addVideo.action"
		method="post"> --%>
			<form class="form-horizontal" action="${pageContext.request.contextPath }/video/addVideo.action"
			method="post">
			    ...
			    <div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" name="videoLength" placeholder="视频时长">
					</div>	
			   </div>
			    ...
			    <div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" name="videoImageUrl" placeholder="封面图片 ">
					</div>	
			   </div>
			   <div class="form-group">
					<label class="col-md-3 control-label">视频播放地址</label>
					<div class="col-md-8">
						<input type="text" class="form-control" name="videoUrl" placeholder="封面图片 ">
					</div>	
			   </div>
		        <div class="form-group ">
			        <label  class="col-md-3 control-label ">视频简介</label>
			        <div class="col-md-8 ">
				    <textarea class="p100 " name="videoDescr" placeholder="视频简介 " style="width: 1000px; height: 100px; "></textarea>
				    </div>
			    </div>
